...
async def stats() -> dict:
    ...
    data["proposal_validation_enabled"] = bool(settings.proposal_validation_enabled)
    data["proposal_min_chars"] = int(settings.proposal_min_chars)
    data["proposal_max_chars"] = int(settings.proposal_max_chars)
    data["proposal_similarity_threshold"] = float(settings.proposal_similarity_threshold)
